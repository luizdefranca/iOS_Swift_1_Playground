 ...
 */
func hey(toPerson1: String , andPerson2: String) -> String {
 return "Hey \(toPerson1) \nHey \(andPerson2)"
}

print(hey(toPerson1: "John", andPerson2: "Raul"))
/*:
 - Callout(Challenge):
...
func subtract(number: Int, withNumber: Int) -> Int{
    return number - withNumber
}

func multiple (number: Int, withNumber: Int) -> Int {
    return number * withNumber
}

func divide (number: Int, withNumber: Int) -> Double {
    return Double(number / withNumber)
}
/*:
 - Callout(Challenge):
...
sayHelloClosureWithReturn("hy")
print(sayHelloClosureWithReturn("August"))
 ...
 */
var myClosure = {(a: String , b:String)->() in
    print(" a ->\(a)  b->\(b)")
}
 ...
 */
var secondClosure = {(para: String)->(String) in
    return String(para.reversed())
}

print(secondClosure("Any thing that I want"))
/*:
 - Callout(Challenge):
